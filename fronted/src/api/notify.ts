...
export const NotifyAPI = {
  list: async (params: { page: number; size: number }): Promise<Result<Page<NotificationVO>>> => {
  ...
  unreadCount: async (): Promise<Result<number>> => {
    const res = await http.get<BackendResult<number>>('/notify/unread/count')
